...
export function MagneticText({
  ...
  return (
    ...
    >
      <span className={`text-5xl sm:text-6xl lg:text-7xl font-serif font-bold tracking-tight ${textColor}`}>
        {text}
      </span>

      <div
        ref={circleRef}
        className="absolute top-0 left-0 pointer-events-none rounded-full bg-[#D4AF37] overflow-hidden"
        style={{
      ...
      >
        ...
        >
          <span className={`text-5xl sm:text-6xl lg:text-7xl font-serif font-bold tracking-tight ${hoverColor} whitespace-nowrap`}>
            {hoverText}
          </span>
        </div>
      </div>
